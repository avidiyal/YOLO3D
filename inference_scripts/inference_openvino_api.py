...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='../weights/onnx/yolov5s.onnx', help='model path(s)')
    ...
    parser.add_argument('--reg_weights', type=str, default='../weights/onnx/resnet18.onnx', help='Regressor model weights')
